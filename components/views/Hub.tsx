...
const Marquee = ({ text }: { text: string }) => (
  <div className="hub-marquee-track relative flex overflow-hidden border-y border-white/5 bg-white/[0.01]">
    <motion.div 
    ...
    >
      {[...Array(8)].map((_, i) => (
        <span key={i} className="hub-marquee-text font-display font-bold text-white/20 px-4 md:px-8 uppercase tracking-widest">
          {text} •
        </span>
      ))}
    </motion.div>
  ...
  return (
    <div className="h-full w-full flex flex-col relative overflow-hidden bg-bg">
      ...
      <div className="flex-1 min-h-0 flex flex-col justify-center w-full max-w-[1800px] mx-auto z-10 overflow-y-auto custom-scrollbar">
        ...
        <div className="hub-hero-spacing hub-hero-layout hub-hero-frame relative px-6 md:px-20 flex flex-col">
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, ease: "easeOut" }}
              className="hub-hero-stack flex flex-col"
            >
              {/* Header Tag */}
              <div className="hub-topline flex flex-wrap items-center gap-2 font-mono text-blockchain tracking-widest">
              ...
              <h1 className="hub-hero-title font-display font-bold tracking-tighter uppercase relative z-20">
              ...
              <div className="hub-meta flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mt-4 border-l-2 border-white/10 pl-6">
                  <p className="hub-description font-sans text-white/50 max-w-lg">
                  ...
                  <button 
                    ...
                    className="hub-cta group flex items-center gap-3 bg-white text-black rounded-sm font-bold tracking-widest hover:bg-blockchain hover:text-white transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                  >
